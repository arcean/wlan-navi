...
# Generated by qmake (2.01a) (Qt 4.7.3) on: wt. maj 3 22:26:15 2011
# Project:  wlan_navi.pro
# Template: app
# Command: /home/Tomek/QtSDK/Simulator/Qt/gcc/bin/qmake -spec /home/Tomek/QtSDK/Simulator/Qt/gcc/mkspecs/linux-g++-64 CONFIG+=debug QMLJSDEBUGGER_PATH=/home/Tomek/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger -o Makefile wlan_navi.pro
#############################################################################
...
CFLAGS        = -m64 -pipe -g -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -pthread -I/usr/include/hildon-1 -I/usr/include/gtk-2.0 -I/usr/lib64/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/dbus-1.0 -I/usr/lib64/dbus-1.0/include -DORBIT2=1 -pthread -I/usr/include/gconf/2 -I/usr/include/orbit-2.0 -I/usr/include/dbus-1.0 -I/usr/lib64/dbus-1.0/include -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -m64 -pipe -g -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -pthread -I/usr/include/hildon-1 -I/usr/include/gtk-2.0 -I/usr/lib64/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/dbus-1.0 -I/usr/lib64/dbus-1.0/include -DORBIT2=1 -pthread -I/usr/include/gconf/2 -I/usr/include/orbit-2.0 -I/usr/include/dbus-1.0 -I/usr/lib64/dbus-1.0/include -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -Wall -W -D_REENTRANT $(DEFINES)
...
SOURCES       = main.cpp \
		...
		config.cpp \
		settings.cpp \
		markerinfo.cpp moc_mainwindow.cpp \
		moc_mapswidget.cpp \
		moc_WlanMaemo.cpp \
		moc_marker.cpp \
...
Makefile: wlan_navi.pro  /home/Tomek/QtSDK/Simulator/Qt/gcc/mkspecs/linux-g++-64/qmake.conf /home/Tomek/QtSDK/Simulator/Qt/gcc/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /home/Tomek/QtSDK/Simulator/Qt/gcc/mkspecs/linux-g++-64 CONFIG+=debug QMLJSDEBUGGER_PATH=/home/Tomek/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger -o Makefile wlan_navi.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/wlan_navi1.0.0/ && $(COPY_FILE) --parents mainwindow.h mapswidget.h WlanMaemo.h marker.h wlanavailable.h config.h settings.h markerinfo.h .tmp/wlan_navi1.0.0/ && $(COPY_FILE) --parents wlan_navi.qrc .tmp/wlan_navi1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp mapswidget.cpp WlanMaemo.cpp marker.cpp wlanavailable.cpp config.cpp settings.cpp markerinfo.cpp .tmp/wlan_navi1.0.0/ && $(COPY_FILE) --parents wlanavailable.ui settings.ui markerinfo.ui .tmp/wlan_navi1.0.0/ && (cd `dirname .tmp/wlan_navi1.0.0` && $(TAR) wlan_navi1.0.0.tar wlan_navi1.0.0 && $(COMPRESS) wlan_navi1.0.0.tar) && $(MOVE) `dirname .tmp/wlan_navi1.0.0`/wlan_navi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/wlan_navi1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_mapswidget.cpp moc_WlanMaemo.cpp moc_marker.cpp moc_wlanavailable.cpp moc_settings.cpp moc_markerinfo.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_mapswidget.cpp moc_WlanMaemo.cpp moc_marker.cpp moc_wlanavailable.cpp moc_settings.cpp moc_markerinfo.cpp
...
moc_markerinfo.cpp: WlanMaemo.h \
		marker.h \
		markerinfo.h
	/home/Tomek/QtSDK/Simulator/Qt/gcc/bin/moc $(DEFINES) $(INCPATH) markerinfo.h -o moc_markerinfo.cpp
...
markerinfo.o: markerinfo.cpp markerinfo.h \
		WlanMaemo.h \
		marker.h \
		ui_markerinfo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o markerinfo.o markerinfo.cpp
...
moc_markerinfo.o: moc_markerinfo.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_markerinfo.o moc_markerinfo.cpp
